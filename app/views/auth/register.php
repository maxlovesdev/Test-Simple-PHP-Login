<?php $title = 'Register'; $bodyClass = 'bg-white'; $showNav = false; require APP . 'views/layout/header.php'; ?>
        ...
        <div class="flex flex-col justify-center md:justify-start my-auto pt-8 md:pt-0 px-8 md:px-24 lg:px-32">
            ...
            <?php if ($success): ?>
                <div class="text-center mt-6">
                    ...
                    <p class="mt-2">You may now <a href="<?= BASE ?>/login/" class="underline font-semibold">log in here.</a></p>
                </div>
            <?php else: ?>
                <?php if ($error): ?>
                ...
                <form class="flex flex-col pt-3 md:pt-8" action="<?= BASE ?>/register/" method="post">
                ...
                <div class="text-center pt-12 pb-12">
                    <p>Already have an account? <a href="<?= BASE ?>/login/" class="underline font-semibold">Log in here.</a></p>
                </div>
            <?php endif; ?>
        </div>
    </div>
